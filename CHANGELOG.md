...
* **stlc:** configurable CI runner and private-production-repo support in workflow templates ([dbb668a](https://github.com/CASParser/cas-parser-go/commit/dbb668adc3c820e3e1c0cf95fbb07a42860f7020))
