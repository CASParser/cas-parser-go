...
func TestUserAgentHeader(t *testing.T) {
	...
	client.CamsKfintech.Parse(context.Background(), casparser.CamsKfintechParseParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.CamsKfintech.Parse(context.Background(), casparser.CamsKfintechParseParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.CamsKfintech.Parse(cancelCtx, casparser.CamsKfintechParseParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.CamsKfintech.Parse(deadlineCtx, casparser.CamsKfintechParseParams{})
		if err == nil {
