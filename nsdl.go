...
// NsdlService contains methods and other services that help with interacting with
// the cas-parser API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewNsdlService] method instead.
type NsdlService struct {
	Options []option.RequestOption
}

// NewNsdlService generates a new service that applies the given options to each
